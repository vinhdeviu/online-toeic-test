...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 13, 2020 lúc 06:04 AM
...
(61, 1, '2020-05-12 05:42:40', 1, 3),
(62, 1, '2020-05-12 05:49:44', 1, 5),
(63, 1, '2020-05-12 05:55:16', 1, 47),
(64, 1, '2020-05-12 05:57:16', 1, 2),
(65, 1, '2020-05-12 05:58:20', 1, 2),
(66, 1, '2020-05-13 10:03:34', 1, 1),
(67, 1, '2020-05-13 10:04:57', 1, 0),
(68, 1, '2020-05-13 10:07:39', 1, 4),
(69, 1, '2020-05-13 10:29:30', 1, 2),
(70, 1, '2020-05-13 10:51:45', 1, 0),
(71, 1, '2020-05-13 10:57:18', 1, 1);
...
INSERT INTO `part` (`id`, `test_id`, `part_num`, `type`, `tittle`, `direction`, `switchable`) VALUES
...
(2, 1, 2, 1, 'Part 2: Question-Response', 'Directions: You will hear a question or statement and three responses spoken in English. They will not be printed in your test book and will be spoken only one time. Select the best response to the question or statement and mark the letter (A), (B ), or (C) on your answer sheet.', 0),
(3, 1, 3, 1, 'Part 3: Conversations', 'Directions: You will hear some conversations between two people. You will be asked to answer three questions about what the speakers say in each conversation. Select the best response to each question and mark the letter (A), (B), (C), or (D) on your answer sheet. The conversations will not be printed in your test book and will be spoken only one time', 0),
(4, 1, 4, 1, 'Part 4: Talks', 'Directions: You will hear some talks given by a single speaker. You will be asked to answer three questions about what the speaker says in each talk. Select the best response to each question and mark the letter (A), (B), (C), or (D) on your answer sheet. The talks will not be printed in your test book and will be spoken only one time.', 0),
(5, 1, 5, 2, 'Part 5: Incomplete Sentences', 'Directions: A word or phrase is missing in each of the following sentences. Four answer choices are given below each sentence. Select the best answer to complete the sentence. Then mark the letter (A), (B), (C), or (D) on your answer sheet.', 1),
(6, 1, 6, 2, 'Part 6: Text Completion', 'Directions: Read the texts that follow. A word or phrase is missing in some of the sentences. Four answer choices are given below each of the sentences. Select the best answer to complete the text. Then mark the letter (A), (B), (C), or (D) on your answer sheet.', 1),
(7, 1, 7, 2, 'Part 7: Reading Comprehension', 'Directions: In this part you will read a selection of texts, such as magazine and newspaper articles, letters, and advertisements. Each text is followed by several questions. Select the best answer for each question and mark the letter (A), (B), (C), or (D) on your answer sheet.', 1);
...
INSERT INTO `question` (`id`, `index`, `part_id`, `group_id`, `image_link`, `question_tittle`, `correct_answer`, `switchable`, `correct_answer_id`) VALUES
(1, 1, 1, NULL, 'http://localhost:3000/image/1_IMAGE_1.jpg', NULL, 'c', 0, NULL),
(2, 2, 1, NULL, 'http://localhost:3000/image/1_IMAGE_2.jpg', NULL, 'a', 0, NULL),
(3, 3, 1, NULL, 'http://localhost:3000/image/1_IMAGE_3.jpg', NULL, 'd', 0, NULL),
(4, 4, 1, NULL, 'http://localhost:3000/image/1_IMAGE_4.jpg', NULL, 'c', 0, NULL),
(5, 5, 1, NULL, 'http://localhost:3000/image/1_IMAGE_5.jpg', NULL, 'b', 0, NULL),
(6, 6, 1, NULL, 'http://localhost:3000/image/1_IMAGE_6.jpg', NULL, 'a', 0, NULL),
(7, 7, 1, NULL, 'http://localhost:3000/image/1_IMAGE_7.jpg', NULL, 'b', 0, NULL),
(8, 8, 1, NULL, 'http://localhost:3000/image/1_IMAGE_8.jpg', NULL, 'c', 0, NULL),
(9, 9, 1, NULL, 'http://localhost:3000/image/1_IMAGE_9.jpg', NULL, 'b', 0, NULL),
(10, 10, 1, NULL, 'http://localhost:3000/image/1_IMAGE_10.jpg', NULL, 'd', 0, NULL),
(11, 11, 2, NULL, NULL, NULL, 'c', 0, NULL),
(12, 12, 2, NULL, NULL, NULL, 'b', 0, NULL),
(13, 13, 2, NULL, NULL, NULL, 'b', 0, NULL),
(14, 14, 2, NULL, NULL, NULL, 'a', 0, NULL),
(15, 15, 2, NULL, NULL, NULL, 'c', 0, NULL),
(16, 16, 2, NULL, NULL, NULL, 'b', 0, NULL),
(17, 17, 2, NULL, NULL, NULL, 'c', 0, NULL),
(18, 18, 2, NULL, NULL, NULL, 'a', 0, NULL),
(19, 19, 2, NULL, NULL, NULL, 'c', 0, NULL),
(20, 20, 2, NULL, NULL, NULL, 'a', 0, NULL),
(21, 21, 2, NULL, NULL, NULL, 'c', 0, NULL),
(22, 22, 2, NULL, NULL, NULL, 'b', 0, NULL),
(23, 23, 2, NULL, NULL, NULL, 'b', 0, NULL),
(24, 24, 2, NULL, NULL, NULL, 'a', 0, NULL),
(25, 25, 2, NULL, NULL, NULL, 'c', 0, NULL),
(26, 26, 2, NULL, NULL, NULL, 'c', 0, NULL),
(27, 27, 2, NULL, NULL, NULL, 'b', 0, NULL),
(28, 28, 2, NULL, NULL, NULL, 'a', 0, NULL),
(29, 29, 2, NULL, NULL, NULL, 'b', 0, NULL),
(30, 30, 2, NULL, NULL, NULL, 'a', 0, NULL),
(31, 31, 2, NULL, NULL, NULL, 'c', 0, NULL),
(32, 32, 2, NULL, NULL, NULL, 'c', 0, NULL),
(33, 33, 2, NULL, NULL, NULL, 'b', 0, NULL),
(34, 34, 2, NULL, NULL, NULL, 'b', 0, NULL),
(35, 35, 2, NULL, NULL, NULL, 'c', 0, NULL),
(36, 36, 2, NULL, NULL, NULL, 'a', 0, NULL),
(37, 37, 2, NULL, NULL, NULL, 'b', 0, NULL),
(38, 38, 2, NULL, NULL, NULL, 'a', 0, NULL),
(39, 39, 2, NULL, NULL, NULL, 'c', 0, NULL),
(40, 40, 2, NULL, NULL, NULL, 'b', 0, NULL),
(41, 41, 3, NULL, NULL, 'What are the speakers mainly discussing?', NULL, 1, 6),
(42, 42, 3, NULL, NULL, 'What can be inferred about the woman?', NULL, 1, 12),
(43, 43, 3, NULL, NULL, 'Why can\'t the woman work on Thursday evenings?', NULL, 1, 14),
(44, 44, 3, NULL, NULL, 'Why is Marcia going to be late?', NULL, 1, 17),
(45, 45, 3, NULL, NULL, 'What does Lyle suggest Marcia do?', NULL, 1, 23),
(46, 46, 3, NULL, NULL, 'Where is Lyle\'s office located?', NULL, 1, 28),
(47, 47, 3, NULL, NULL, 'What position does the woman most likely hold?', NULL, 1, 31),
(48, 48, 3, NULL, NULL, 'What is implied about the man?', NULL, 1, 34),
(49, 49, 3, NULL, NULL, 'What will the man probably do next?', NULL, 1, 38),
(50, 50, 3, NULL, NULL, 'Who most likely are the speakers?', NULL, 1, 44),
(51, 51, 3, NULL, NULL, 'What problem does the woman have?', NULL, 1, 47),
(52, 52, 3, NULL, NULL, 'What does the man suggest?', NULL, 1, 49),
(53, 53, 3, NULL, NULL, 'What does the man want to do?', NULL, 1, 53),
(54, 54, 3, NULL, NULL, 'What does the woman suggest the man do?', NULL, 1, 57),
(55, 55, 3, NULL, NULL, 'What will the man probably do next?', NULL, 1, 64),
(56, 56, 3, NULL, NULL, 'Who most likely is Byron?', NULL, 1, 66),
(57, 57, 3, NULL, NULL, 'Why does Jennifer think Byron might have difficulty?', NULL, 1, 72),
(58, 58, 3, NULL, NULL, 'What does Byron say about the condos?', NULL, 1, 76),
(59, 59, 3, NULL, NULL, 'What are the speakers doing?', NULL, 1, 77),
(60, 60, 3, NULL, NULL, 'Why is the man worried about money?', NULL, 1, 82),
(61, 61, 3, NULL, NULL, 'What does the woman offer to do?', NULL, 1, 90),
(62, 62, 3, NULL, NULL, 'Where is this conversation most likely taking place?', NULL, 1, 94),
(63, 63, 3, NULL, NULL, 'What does the woman suggest the man do?', NULL, 1, 99),
(64, 64, 3, NULL, NULL, 'What can be inferred about the man?', NULL, 1, 101),
(65, 65, 3, NULL, NULL, 'What is the man trying to do?', NULL, 1, 104),
(66, 66, 3, NULL, NULL, 'How does the woman help the man?', NULL, 1, 110),
(67, 67, 3, NULL, NULL, 'What does the woman imply about members of her family?', NULL, 1, 112),
(68, 68, 3, NULL, NULL, 'Where is this conversation most likely taking place?', NULL, 1, 117),
(69, 69, 3, NULL, NULL, 'What does the woman want to do?', NULL, 1, 122),
(70, 70, 3, NULL, NULL, 'What does the man suggest?', NULL, 1, 124),
(71, 71, 4, NULL, NULL, 'What is the main purpose of the announcement?', NULL, 1, 154),
(72, 72, 4, NULL, NULL, 'What will happen on Main Street?', NULL, 1, 148),
(73, 73, 4, NULL, NULL, 'According to the speaker, how can listeners get more information?', NULL, 1, 145),
(74, 74, 4, NULL, NULL, 'Who is the intended audience?', NULL, 1, 142),
(75, 75, 4, NULL, NULL, 'What does the speaker say about traffic?', NULL, 1, 139),
(76, 76, 4, NULL, NULL, 'What will listeners hear next?', NULL, 1, 132),
(77, 77, 4, NULL, NULL, 'Who is the message for?', NULL, 1, 131),
(78, 78, 4, NULL, NULL, 'What should listeners do if they want to make an appointment?', NULL, 1, 158),
(79, 79, 4, NULL, NULL, 'When should listeners call the answering service?', NULL, 1, 163),
(80, 80, 4, NULL, NULL, 'What position does the speaker most likely hold?', NULL, 1, 164),
(81, 81, 4, NULL, NULL, 'What is the speaker mainly discussing?', NULL, 1, 169),
(82, 82, 4, NULL, NULL, 'The speaker mentions all of the following EXCEPT', NULL, 1, 175),
(83, 83, 4, NULL, NULL, 'What is the speaker mainly discussing?', NULL, 1, 178),
(84, 84, 4, NULL, NULL, 'According to the speaker, how would customers spend $500?', NULL, 1, 181),
(85, 85, 4, NULL, NULL, 'What does the speaker say about the economy?', NULL, 1, 185),
(86, 86, 4, NULL, NULL, 'What is being advertised?', NULL, 1, 191),
(87, 87, 4, NULL, NULL, 'What does the speaker offer?', NULL, 1, 194),
(88, 88, 4, NULL, NULL, 'What does the speaker urge listeners to do?', NULL, 1, 196),
(89, 89, 4, NULL, NULL, 'What is being announced?', NULL, 1, 201),
(90, 90, 4, NULL, NULL, 'According to the speaker, what will remain the same?', NULL, 1, 206),
(91, 91, 4, NULL, NULL, 'What should listeners do if they have questions?', NULL, 1, 208),
(92, 92, 4, NULL, NULL, 'Who is the message for?', NULL, 1, 212),
(93, 93, 4, NULL, NULL, 'Why is the speaker calling?', NULL, 1, 219),
(94, 94, 4, NULL, NULL, 'What should the listener do next?', NULL, 1, 221),
(95, 95, 4, NULL, NULL, 'Where is this report most likely being broadcast?', NULL, 1, 226),
(96, 96, 4, NULL, NULL, 'What kind of weather does the speaker predict for tomorrow?', NULL, 1, 228),
(97, 97, 4, NULL, NULL, 'What can be inferred about this report?', NULL, 1, 234),
(98, 98, 4, NULL, NULL, 'Who most likely is the speaker?', NULL, 1, 239),
(99, 99, 4, NULL, NULL, 'What did Neal Trapp do at age 22?', NULL, 1, 243),
(100, 100, 4, NULL, NULL, 'What does the speaker say about Neal Trapp\'s novel?', NULL, 1, 245),
(101, NULL, 5, NULL, NULL, 'Employees who wish to take the day after Thanksgiving as a personal day off _____ to get managerial approval.', NULL, 1, 316),
(102, NULL, 5, NULL, NULL, 'Mr. Hernandez _____ to Switzerland on a business trip, but messages can be relayed to him through his secretary, Ms. Constantinople..', NULL, 1, 317),
(103, NULL, 5, NULL, NULL, 'After several days of negotiations, Turner Associates finally made a marketing _____ with Ignatius Imports.', NULL, 1, 324),
(104, NULL, 5, NULL, NULL, 'In Mr. Carter\'s absence, inquiries should be directed to his _____, Mr. Zimbrowski.', NULL, 1, 327),
(105, NULL, 5, NULL, NULL, 'Wilson Electronics announced Tuesday that 500 workers will be _____ off next month due to the slumping economy.', NULL, 1, 330),
(106, NULL, 5, NULL, NULL, 'The post office is located _____ the end of the block, next to Charlestown Dry Cleaners.', NULL, 1, 334),
(107, NULL, 5, NULL, NULL, 'Mrs. Summers complained that the CEO\'s power-point presentation on the history of modern architecture was _____.', NULL, 1, 337),
(108, NULL, 5, NULL, NULL, 'Mr. Hawkins is a hard worker who usually performs quite _____ under pressure.', NULL, 1, 343),
(109, NULL, 5, NULL, NULL, 'Because of _____ exceptional durability, IXC chips are in high demand for the new QC operating systems.', NULL, 1, 345),
(110, NULL, 5, NULL, NULL, 'The Daily Times reports that the bubble has burst on the _____ housing market, sending home prices spiraling sharply downward.', NULL, 1, 351),
(111, NULL, 5, NULL, NULL, 'Two delays, a thunderstorm and a missed connection combined to make Mr. Cox\'s cross country flight _____ miserable.', NULL, 1, 356),
(112, NULL, 5, NULL, NULL, '\"Customers come first\" has always been one of the key business _____ at M & M Mortgages.', NULL, 1, 358),
(113, NULL, 5, NULL, NULL, '_____ clients should be apprised of purchasing arrangements before they commit to a long-term contract.', NULL, 1, 361),
(114, NULL, 5, NULL, NULL, 'The Xerxes Corporation plans _____ next year with the opening of branch offices in Zurich, Amsterdam and Tokyo.', NULL, 1, 368),
(115, NULL, 5, NULL, NULL, '_____ heavy rain, this afternoon\'s baseball game has been rescheduled for Friday.', NULL, 1, 369),
(116, NULL, 5, NULL, NULL, 'During the meeting, Zeke Grabowski made _____ loud and clear about his position on the firm\'s proposed acquisition of Penny Pharmaceuticals.', NULL, 1, 375),
(117, NULL, 5, NULL, NULL, 'To be valid under state law, the contract requires the _____ of the company\'s CFO as well as its chairman.', NULL, 1, 378),
(118, NULL, 5, NULL, NULL, 'Though not a sworn vegetarian, Health.com Chairman Harold Hopper _____ eats meat.', NULL, 1, 382),
(119, NULL, 5, NULL, NULL, 'After speeding to the airport and sprinting across the terminal, the PelCro Corp. executives arrived just _____ time to catch their flight.', NULL, 1, 387),
(120, NULL, 5, NULL, NULL, 'We cannot overemphasize the _____ of delivering the shipment by no later than noon on Friday the 13th.', NULL, 1, 391),
(121, NULL, 5, NULL, NULL, 'Mr. Zenter explained that he _____ couldn\'t justify the capital expenditure required to finance Ms. Ruble\'s start-up company.', NULL, 1, 393),
(122, NULL, 5, NULL, NULL, 'Ms. Mertenson will be unavailable next week _____ you have made a previous appointment.', NULL, 1, 398),
(123, NULL, 5, NULL, NULL, 'Channel 2\'s weather forecasts are more reliable than Channel 7\'s, because its meteorologists have better credentials and are more _____.', NULL, 1, 404),
(124, NULL, 5, NULL, NULL, 'Rucker Limited\'s second-quarter earnings were significantly affected by a _____ economy, which has led to rising unemployment and threat of increased inflation.', NULL, 1, 408),
(125, NULL, 5, NULL, NULL, 'Since the restaurant had _____ out of lobster, it gave us a discount on prawns and chips.', NULL, 1, 409),
(126, NULL, 5, NULL, NULL, 'If the intended _____ is not at home, leave notification that the package may be picked up at the post office during regular business hours.', NULL, 1, 416),
(127, NULL, 5, NULL, NULL, 'Research director Tom Montgomery said he can\'t predict when the new arthritis drug will be ready, but he assured the board that his department is _____ making progress.', NULL, 1, 419),
(128, NULL, 5, NULL, NULL, 'Mrs. Hammersmith asked Ms. Cotton to fax her _____ layout for the new advertisement as soon as possible, because deadline was approaching.', NULL, 1, 422),
(129, NULL, 5, NULL, NULL, 'Ms. Griffiths was eliminated as a candidate when she answered yes to the question, \"Have you ever _____ anything from a previous employer?\"', NULL, 1, 425),
(130, NULL, 5, NULL, NULL, 'Each employee has an important _____ to play in ensuring the success of our business model.', NULL, 1, 429),
(131, 131, 6, 1, NULL, NULL, NULL, 1, 250),
(132, 132, 6, 1, NULL, NULL, NULL, 1, 255),
(133, 133, 6, 1, NULL, NULL, NULL, 1, 257),
(134, 134, 6, 1, NULL, NULL, NULL, 1, 264),
(135, 135, 6, 2, NULL, NULL, NULL, 1, 268),
(136, 136, 6, 2, NULL, NULL, NULL, 1, 271),
(137, 137, 6, 2, NULL, NULL, NULL, 1, 273),
(138, 138, 6, 2, NULL, NULL, NULL, 1, 278),
(139, 139, 6, 3, NULL, NULL, NULL, 1, 281),
(140, 140, 6, 3, NULL, NULL, NULL, 1, 287),
(141, 141, 6, 3, NULL, NULL, NULL, 1, 289),
(142, 142, 6, 3, NULL, NULL, NULL, 1, 294),
(143, 143, 6, 4, NULL, NULL, NULL, 1, 298),
(144, 144, 6, 4, NULL, NULL, NULL, 1, 301),
(145, 145, 6, 4, NULL, NULL, NULL, 1, 308),
(146, 146, 6, 4, NULL, NULL, NULL, 1, 312),
(147, NULL, NULL, 5, NULL, 'What discount is offered on the cost of renting a car?', NULL, 1, 434),
(148, NULL, NULL, 5, NULL, 'How much would a 70 year-old person pay for a package that includes the Native American show?', NULL, 1, 439),
(149, NULL, NULL, 6, NULL, 'What is the main purpose of this memo?', NULL, 1, 444),
(150, NULL, NULL, 6, NULL, 'When does the change take effect?', NULL, 1, 448),
(151, NULL, NULL, 6, NULL, 'What should supervisors do if they have questions?', NULL, 1, 450),
(152, NULL, NULL, 7, NULL, 'What can be inferred about Jean?', NULL, 1, 453),
(153, NULL, NULL, 7, NULL, 'What is NOT cited as part of Jean\'s work?', NULL, 1, 458),
(154, NULL, NULL, 7, NULL, 'What does Thomas say about Jean?', NULL, 1, 462),
(155, NULL, NULL, 7, NULL, 'What does Thomas offer to do for Jean?', NULL, 1, 468),
(156, NULL, NULL, 8, NULL, 'What information must the subscriber provide to receive promotional offers?', NULL, 1, 472),
(157, NULL, NULL, 8, NULL, 'What information is included on this card?', NULL, 1, 474),
(158, NULL, NULL, 9, NULL, 'According to the advertisement, what is provided for free at the hotel?', NULL, 1, 477),
(159, NULL, NULL, 9, NULL, 'What is NOT mentioned about the hotel?', NULL, 1, 483),
(160, NULL, NULL, 10, NULL, 'What does Andrew Huff suggest about the book?', NULL, 1, 487),
(161, NULL, NULL, 10, NULL, 'What is NOT mentioned as being included in the book?', NULL, 1, 492),
(162, NULL, NULL, 10, NULL, 'For what group is the book particularly recommended?', NULL, 1, 493),
(163, NULL, NULL, 11, NULL, 'What kind of business is Amarin, Ltd.?', NULL, 1, 500),
(164, NULL, NULL, 11, NULL, 'What is stated in the letter about Amarin, Ltd.?', NULL, 1, 501),
(165, NULL, NULL, 11, NULL, 'What did the writer want to emphasize about his background?', NULL, 1, 507),
(166, NULL, NULL, 11, NULL, 'What does the letter indicate is a sign that Amarin, Ltd., is doing very well?', NULL, 1, 512),
(167, NULL, NULL, 12, NULL, 'What institution is being discussed?', NULL, 1, 515),
(168, NULL, NULL, 12, NULL, 'Who contributed money to this institution?', NULL, 1, 519),
(169, NULL, NULL, 12, NULL, 'According to the minutes, what remark did Ms. Sprague make?', NULL, 1, 524),
(170, NULL, NULL, 13, NULL, 'Which model is best if cost is a concern?', NULL, 1, 525),
(171, NULL, NULL, 13, NULL, 'What is suggested about changing the lighting in a home or office?', NULL, 1, 530),
(172, NULL, NULL, 13, NULL, 'Why are the lighting models mentioned in the brochure?', NULL, 1, 536),
(173, NULL, NULL, 13, NULL, 'According to the brochure, what is NOT true of energy-efficient lights?', NULL, 1, 539),
(174, NULL, NULL, 13, NULL, 'What is true of Mystic lights?', NULL, 1, 541),
(175, NULL, NULL, 14, NULL, 'What is the main purpose of MEP?', NULL, 1, 547),
(176, NULL, NULL, 14, NULL, 'In the article, the word \"green\" in paragraph 1, line 2, is closest in meaning to', NULL, 1, 550),
(177, NULL, NULL, 14, NULL, 'Who is Mark McCartney?', NULL, 1, 556),
(178, NULL, NULL, 14, NULL, 'What is NOT true?', NULL, 1, 557),
(179, NULL, NULL, 14, NULL, 'According to the article, how much money did MEP help firms save last year?', NULL, 1, 564),
(180, NULL, NULL, 15, NULL, 'What is the main function of the invoice?', NULL, 1, 567),
(181, NULL, NULL, 15, NULL, 'What can be inferred about Stanley Supplies and Office Corral?', NULL, 1, 570),
(182, NULL, NULL, 15, NULL, 'In the e-mail, the word \"discrepancies\" in paragraph 2, line 1, is closest in meaning to', NULL, 1, 573),
(183, NULL, NULL, 15, NULL, 'How many additional crates of computer chairs is Ms. Velasquiz expecting?', NULL, 1, 579),
(184, NULL, NULL, 15, NULL, 'According to the invoice, why did Office Corral receive free promotional brochures?', NULL, 1, 582),
(185, NULL, NULL, 16, NULL, 'In the invitation, the letters \"RSVP\" in paragraph 4, line 1, are closest in meaning to', NULL, 1, 585),
(186, NULL, NULL, 16, NULL, 'Why is the invitation mainly being sent?', NULL, 1, 590),
(187, NULL, NULL, 16, NULL, 'Who is Howard Jacobson?', NULL, 1, 595),
(188, NULL, NULL, 16, NULL, 'What time does Patty Pakola\'s flight leave for China?', NULL, 1, 598),
(189, NULL, NULL, 16, NULL, 'What can be inferred about Gloria Stroust?', NULL, 1, 601),
(190, NULL, NULL, 17, NULL, 'What is the main purpose of the notice?', NULL, 1, 608),
(191, NULL, NULL, 17, NULL, 'How many Water Exercise classes will be affected by the pool closure?', NULL, 1, 610),
(192, NULL, NULL, 17, NULL, 'What is NOT true?', NULL, 1, 615),
(193, NULL, NULL, 17, NULL, 'In the schedule, the word \"aqua\" in line 4 is closest in meaning to', NULL, 1, 618),
(194, NULL, NULL, 17, NULL, 'According to the schedule, how would someone find out more about the Masters Workout?', NULL, 1, 621),
(195, NULL, NULL, 18, NULL, 'What event is the open house celebrating?', NULL, 1, 628),
(196, NULL, NULL, 18, NULL, 'What event is the open house celebrating?', NULL, 1, 630),
(197, NULL, NULL, 18, NULL, 'In the invitation, the term \"Hors devours\" is closest in meaning to', NULL, 1, 633),
(198, NULL, NULL, 18, NULL, 'Why can\'t Robin attend the open house?', NULL, 1, 639),
(199, NULL, NULL, 18, NULL, 'What can be inferred about Robin?', NULL, 1, 644),
(200, NULL, NULL, 5, NULL, 'What discount is offered on the cost of renting a car?', NULL, 1, 647);
...
INSERT INTO `question_group` (`id`, `index`, `tittle`, `part_id`, `image_link`, `paragraph`, `switchable`) VALUES
